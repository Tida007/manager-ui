...
function Header() {
    ...
    return (
        <div className="flex justify-between items-center p-2 mt-4 shadow-md rounded-lg max-w-6xl mx-auto bg-auto bg-white dark:bg-gray-700 text-black dark:text-white">
